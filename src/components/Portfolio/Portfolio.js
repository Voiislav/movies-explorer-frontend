...
function Portfolio() {
  return (
    ...
    <ul className="portfolio__links">
      <li className='portfolio__link-container'><a className="portfolio__link" href="https://voiislav.github.io/how-to-learn/" target="_blank" rel="noopener noreferrer">Статичный сайт</a></li>
      <li className='portfolio__link-container'><a href="https://voiislav.github.io/how-to-learn/" target="_blank" rel="noopener noreferrer"><img className="portfolio__arrow" alt="стрелка" src={arrowIcon}></img></a></li>
